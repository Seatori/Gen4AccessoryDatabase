...
# 1
white_fluff = AccessoryData("White Fluff", 1,          2, 1, 0, 1, 2, 1, 1, 2, 0, 1, 0, 1)
yellow_fluff = AccessoryData("Yellow Fluff", 1,        2, 2, 0, 1, 2, 1, 1, 2, 1, 1, 0, 1)
pink_fluff = AccessoryData("Pink Fluff", 1,            1, 2, 0, 1, 2, 1, 1, 2, 1, 1, 0, 1)
brown_fluff = AccessoryData("Brown Fluff", 1,          1, 2, 0, 1, 2, 1, 1, 2, 2, 1, 0, 1)
black_fluff = AccessoryData("Black Fluff", 1,          0, 2, 0, 1, 2, 1, 1, 2, 2, 1, 0, 1)
orange_fluff = AccessoryData("Orange Fluff", 1,        1, 2, 0, 1, 2, 1, 1, 2, 1, 1, 0, 1)
# 2
round_pebble = AccessoryData("Round Pebble", 2,        1, 1, 1, 1, 0, 2, 0, 1, 1, 2, 0, 2)
...
jagged_boulder = AccessoryData("Jagged Boulder", 2,    1, 0, 0, 0, 0, 1, 0, 2, 2, 2, 0, 2)
black_pebble = AccessoryData("Black Pebble", 2,        0, 2, 1, 1, 0, 2, 0, 1, 2, 2, 0, 2)
...
green_scale = AccessoryData("Green Scale", 3,          1, 2, 0, 1, 1, 2, 1, 2, 1, 1, 0, 2)
...
narrow_scale = AccessoryData("Narrow Scale", 3,        0, 1, 0, 1, 1, 2, 1, 2, 2, 1, 2, 2)
# 4
...
white_moustache = AccessoryData("White Moustache", 5,  2, 1, 2, 0, 2, 2, 1, 0, 0, 1, 1, 1)
...
# 6
shed_claw = AccessoryData("Shed Claw", 6,              2, 0, 1, 1, 0, 1, 1, 2, 0, 2, 2, 2)
shed_horn = AccessoryData("Shed Horn", 6,              2, 0, 1, 1, 0, 1, 1, 2, 0, 2, 2, 2)
thin_mushroom = AccessoryData("Thin Mushroom", 6,      2, 1, 1, 1, 1, 1, 1, 2, 0, 1, 2, 1)
thick_mushroom = AccessoryData("Thick Mushroom", 6,    1, 1, 1, 1, 1, 1, 1, 2, 0, 2, 1, 1)
stump = AccessoryData("Stump", 6,                      1, 0, 1, 0, 0, 1, 1, 2, 1, 2, 1, 2)
# 7
pretty_dewdrop = AccessoryData("Pretty Dewdrop", 7,    1, 1, 0, 2, 2, 1, 2, 2, 0, 1, 0, 0)
snow_crystal = AccessoryData("Snow Crystal", 7,        2, 1, 0, 2, 2, 1, 2, 2, 0, 1, 1, 0)
sparks = AccessoryData("Sparks", 7,                    2, 1, 1, 2, 2, 1, 2, 2, 1, 0, 0, 0)
shimmering_fire = AccessoryData("Shimmering Fire", 7,  2, 1, 1, 2, 2, 2, 2, 2, 1, 0, 0, 0)
mystic_fire = AccessoryData("Mystic Fire", 7,          2, 1, 1, 2, 2, 1, 2, 2, 1, 0, 0, 0)
# 8
determination = AccessoryData("Determination", 8,      2, 1, 1, 1, 2, 2, 2, 1, 1, 0, 1, 0)
peculiar_spoon = AccessoryData("Peculiar Spoon", 8,    1, 0, 2, 1, 1, 1, 0, 0, 1, 2, 1, 2)
puffy_smoke = AccessoryData("Puffy Smoke", 8,          1, 1, 0, 0, 2, 1, 2, 2, 1, 0, 0, 0)
poison_extract = AccessoryData("Poison Extract", 8,    0, 2, 1, 0, 2, 0, 2, 2, 2, 0, 0, 0)
# 9
wealthy_coin = AccessoryData("Wealthy Coin", 9,        1, 1, 2, 2, 0, 2, 0, 0, 0, 2, 0, 2)
...
seashell = AccessoryData("Seashell", 9,                2, 0, 0, 1, 0, 1, 1, 2, 1, 2, 1, 2)
humming_note = AccessoryData("Humming Note", 9,        1, 1, 2, 2, 2, 2, 2, 1, 1, 0, 1, 1)
shiny_powder = AccessoryData("Shiny Powder", 9,        2, 1, 2, 2, 2, 2, 2, 1, 0, 1, 0, 1)
...
gorgeous_specs = AccessoryData("Gorgeous Specs", 11,   0, 2, 2, 2, 0, 2, 1, 0, 1, 2, 1, 2)
sweet_candy = AccessoryData("Sweet Candy", 11,         1, 1, 2, 1, 1, 2, 1, 0, 1, 2, 1, 2)
confetti = AccessoryData("Confetti", 11,               1, 2, 2, 1, 2, 2, 2, 0, 1, 1, 1, 1)
# 12
colored_parasol = AccessoryData("Colored Parasol", 12, 2, 2, 2, 2, 1, 2, 1, 0, 1, 2, 2, 2)
old_umbrella = AccessoryData("Old Umbrella", 12,       1, 1, 2, 0, 1, 1, 1, 0, 2, 2, 2, 2)
spotlight = AccessoryData("Spotlight", 12,             2, 0, 2, 2, 1, 2, 2, 0, 0, 2, 1, 2)
cape = AccessoryData("Cape", 12,                       0, 2, 2, 1, 2, 2, 1, 0, 2, 2, 2, 1)
standing_mike = AccessoryData("Standing Mike", 12,     1, 1, 2, 1, 1, 2, 1, 0, 1, 2, 2, 2)
surfboard = AccessoryData("Surfboard", 12,             1, 1, 2, 1, 0, 2, 1, 0, 1, 2, 2, 2)
carpet = AccessoryData("Carpet", 12,                   1, 2, 2, 2, 2, 2, 2, 0, 1, 2, 0, 2)
retro_pipe = AccessoryData("Retro Pipe", 12,           1, 1, 2, 0, 0, 1, 0, 0, 1, 2, 1, 2)
fluffy_bed = AccessoryData("Fluffy Bed", 12,           1, 1, 2, 1, 2, 2, 1, 0, 1, 2, 0, 1)
mirror_ball = AccessoryData("Mirror Ball", 12,         2, 1, 2, 2, 0, 2, 1, 0, 0, 2, 0, 2)
photo_board = AccessoryData("Photo Board", 12,         1, 1, 2, 1, 1, 2, 2, 0, 1, 2, 1, 2)
# 13
