...
yellow_fluff = AccessoryData("Yellow Fluff", 1,        2, 2, 0, 1, 2, 1, 1, 2, 1, 1, 0, 1, False)
pink_fluff = AccessoryData("Pink Fluff", 1,            1, 2, 0, 1, 2, 1, 1, 2, 1, 1, 0, 1, False)
brown_fluff = AccessoryData("Brown Fluff", 1,          1, 2, 0, 1, 2, 1, 1, 2, 2, 1, 0, 1, False)
black_fluff = AccessoryData("Black Fluff", 1,          0, 2, 0, 1, 2, 1, 1, 2, 2, 1, 0, 1, False)
orange_fluff = AccessoryData("Orange Fluff", 1,        1, 2, 0, 1, 2, 1, 1, 2, 1, 1, 0, 1, False)
# 2
round_pebble = AccessoryData("Round Pebble", 2,        1, 1, 1, 1, 0, 2, 0, 1, 1, 2, 0, 2, False)
glitter_boulder = AccessoryData("Glitter Boulder", 2,  2, 1, 1, 2, 0, 2, 0, 1, 0, 2, 0, 2, False)
snaggy_pebble = AccessoryData("Snaggy Pebble", 2,      1, 0, 0, 0, 0, 1, 0, 2, 1, 2, 0, 2, False)
...
mini_pebble = AccessoryData("Mini Pebble", 2,          1, 1, 1, 1, 0, 2, 0, 1, 1, 2, 0, 2, False)
# 3
pink_scale = AccessoryData("Pink Scale", 3,            1, 2, 0, 1, 1, 2, 1, 2, 1, 1, 1, 2, False)
blue_scale = AccessoryData("Blue Scale", 3,            1, 2, 0, 1, 1, 2, 1, 2, 2, 1, 2, 2, False)
green_scale = AccessoryData("Green Scale", 3,          1, 2, 0, 1, 1, 2, 1, 2, 1, 1, 0, 2, False)
purple_scale = AccessoryData("Purple Scale", 3,        1, 2, 0, 1, 1, 2, 1, 2, 1, 1, 2, 2, False)
big_scale = AccessoryData("Big Scale", 3,              2, 1, 0, 1, 1, 2, 1, 2, 0, 1, 2, 2, False)
narrow_scale = AccessoryData("Narrow Scale", 3,        0, 1, 0, 1, 1, 2, 1, 2, 2, 1, 2, 2, False)
# 4
blue_feather = AccessoryData("Blue Feather", 4,        1, 2, 0, 1, 1, 2, 1, 2, 1, 1, 2, 1, False)
red_feather = AccessoryData("Red Feather", 4,          1, 2, 0, 1, 1, 2, 1, 2, 1, 1, 2, 1, False)
yellow_feather = AccessoryData("Yellow Feather", 4,    2, 2, 0, 1, 1, 2, 1, 2, 1, 1, 2, 1, False)
white_feather = AccessoryData("White Feather", 4,      2, 2, 0, 1, 1, 2, 1, 2, 0, 1, 2, 1, False)
# 5
black_moustache = AccessoryData("Black Moustache", 5,  0, 2, 2, 0, 2, 2, 1, 0, 2, 1, 1, 1, False)
white_moustache = AccessoryData("White Moustache", 5,  2, 1, 2, 0, 2, 2, 1, 0, 0, 1, 1, 1, False)
black_beard = AccessoryData("Black Beard", 5,          0, 2, 2, 0, 2, 2, 1, 0, 2, 1, 2, 1, False)
white_beard = AccessoryData("White Beard", 5,          2, 1, 2, 0, 2, 2, 1, 0, 0, 1, 2, 1, False)
small_leaf = AccessoryData("Small Leaf", 5,            1, 1, 0, 0, 2, 1, 1, 2, 1, 1, 1, 1, False)
big_leaf = AccessoryData("Big Leaf", 5,                1, 1, 0, 0, 2, 1, 1, 2, 1, 2, 1, 1, False)
...
thin_mushroom = AccessoryData("Thin Mushroom", 6,      2, 1, 1, 1, 1, 1, 1, 2, 0, 1, 2, 1, False)
...
# 10
red_flower = AccessoryData("Red Flower", 10,           1, 2, 0, 1, 1, 1, 1, 2, 1, 2, 1, 1, False)
pink_flower = AccessoryData("Pink Flower", 10,         1, 2, 0, 1, 1, 1, 1, 2, 1, 2, 1, 1, False)
white_flower = AccessoryData("White Flower", 10,       2, 1, 0, 1, 1, 1, 1, 2, 0, 2, 1, 1, False)
blue_flower = AccessoryData("Blue Flower", 10,         1, 2, 0, 1, 1, 1, 1, 2, 1, 2, 1, 1, False)
orange_flower = AccessoryData("Orange Flower", 10,     1, 2, 0, 1, 1, 1, 1, 2, 1, 2, 1, 1, False)
yellow_flower = AccessoryData("Yellow Flower", 10,     2, 2, 0, 1, 1, 1, 1, 2, 1, 2, 1, 1, False)
# 11
googly_specs = AccessoryData("Googly Specs", 11,       1, 1, 2, 0, 0, 1, 1, 0, 2, 2, 1, 2, False)
black_specs = AccessoryData("Black Specs", 11,         0, 2, 2, 0, 0, 2, 1, 0, 2, 2, 1, 2, False)
